...
from app.libraries.database_manipulation import populate_database_with_glance, update_dynamic_tables, update_tweet_table_1_from_local_csv, update_police_shooting_per_month_table
...
def make_shell_context():
    ...
    return {'db': db, 'Election': Election, 'GoogleMobility': GoogleMobility, 'Cases': Cases, 'populate_database_with_glance': populate_database_with_glance, 'update_dynamic_tables': update_dynamic_tables,
            'get_data_for_query': get_data_for_query, 'update_tweet_table_1_from_local_csv': update_tweet_table_1_from_local_csv, 'update_police_shooting_per_month_table': update_police_shooting_per_month_table}
